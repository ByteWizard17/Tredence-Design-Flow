...
function readString(source, start, line, col, prev) {
  ...
  var code = 0;
  var value = "";
  while (position2 < body2.length && !isNaN(code = body2.charCodeAt(position2)) && // not LineTerminator
  code !== 10 && code !== 13) {
    if (code === 34) {
...
function readBlockString(source, start, line, col, prev, lexer) {
  ...
  while (position2 < body2.length && !isNaN(code = body2.charCodeAt(position2))) {
    ...
    if (code === 10) {
      ...
      // Escape Triple-Quote (\""")
      code === 92 && body2.charCodeAt(position2 + 1) === 34 && body2.charCodeAt(position2 + 2) === 34 && body2.charCodeAt(position2 + 3) === 34
    ) {
      rawValue += body2.slice(chunkStart, position2) + '"""';
      position2 += 4;
      chunkStart = position2;
...
function readName(source, start, line, col, prev) {
  ...
  var position2 = start + 1;
  var code = 0;
  while (position2 !== bodyLength && !isNaN(code = body2.charCodeAt(position2)) && (code === 95 || // _
  code >= 48 && code <= 57 || // 0-9
  code >= 65 && code <= 90 || // A-Z
  code >= 97 && code <= 122)) {
    ++position2;
...
var getResponse = (request, handlers, resolutionContext) => __awaiter(void 0, void 0, void 0, function* () {
...
var jsLevenshtein = /* @__PURE__ */ function() {
      ...
      return __generator$2(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!message.startsWith("request:")) return [3, 2];
...
Object.defineProperty(fetch2, "__esModule", { value: true });
var interceptFetch_1 = fetch2.interceptFetch = void 0;
...
interceptFetch_1 = fetch2.interceptFetch = interceptFetch;
...
var pureXMLHttpRequest = (
  ...
  typeof window === "undefined" ? void 0 : window.XMLHttpRequest
);
...
msw/lib/esm/RequestHandler-deps.js:
  (*! *****************************************************************************
